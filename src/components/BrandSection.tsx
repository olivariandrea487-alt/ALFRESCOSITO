  ...
  return (
    <section id="brands" ref={sectionRef} className="py-24 bg-[#f6e4d4] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-[#2f3031] mb-4 tracking-tight">
            I Nostri Progetti
          </h2>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="p-8 md:p-12">
                  <div className="inline-block px-4 py-1 bg-gray-100 rounded-full mb-4">
                    <span className="text-sm font-semibold text-gray-700">PASTA ARTIGIANALE</span>
                  </div>
                  <h3 className="text-4xl md:text-5xl font-bold text-[#2f3031] mb-4 tracking-tight">
                    Pasta d'uomo
                  </h3>
                  ...
                  <button className="inline-flex items-center gap-2 bg-[#2f3031] text-white px-8 py-4 rounded-full font-semibold hover:bg-[#3d3f40] transition-all duration-300 hover:gap-4 shadow-lg hover:shadow-xl">
                    Scopri di più
            ...
            <div className="group bg-white rounded-3xl shadow-xl hover:shadow-2xl overflow-hidden transition-all duration-500 hover:-translate-y-2 border-2 border-gray-100">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="p-8 md:p-12 order-2 md:order-1">
                  <div className="inline-block px-4 py-1 bg-gray-100 rounded-full mb-4">
                    <span className="text-sm font-semibold text-gray-700">INCLUSIONE SOCIALE</span>
                  </div>
                  <h3 className="text-4xl md:text-5xl font-bold text-[#2f3031] mb-4 tracking-tight">
                    Imbandita
                  </h3>
