        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          <div className="space-y-6">
            <div className="flex flex-col gap-3">
              <img src={logoPasta} alt="Pasta d'uomo" className="h-10 invert brightness-0 invert" />
              <img src={logoImbandita} alt="Imbandita" className="h-8 invert brightness-0 invert" />
            </div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#248acc] transition-all duration-300 hover:scale-110"
              >
          ...
          <div>
            <h3 className="text-xl font-bold mb-6 text-[#248acc]">
              Link Rapidi
            </h3>
            <ul className="space-y-3">
              <li>
                <a href="#home" className="text-gray-300 hover:text-[#248acc] transition-colors">
                  Home
                </a>
              </li>
              <li>
                <a href="#about" className="text-gray-300 hover:text-[#248acc] transition-colors">
                  Chi Siamo
                </a>
              </li>
              <li>
                <a href="#brands" className="text-gray-300 hover:text-[#248acc] transition-colors">
                  I Nostri Progetti
                </a>
              </li>
              <li>
                <a href="#products" className="text-gray-300 hover:text-[#248acc] transition-colors">
                  Prodotti
                </a>
              </li>
              <li>
                <a href="#contact" className="text-gray-300 hover:text-[#248acc] transition-colors">
                  Contatti
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3 text-gray-300">
                ...
                <a href="tel:+390456717635" className="hover:text-[#248acc] transition-colors">
                  +39 045 6717635
                </a>
              </li>
              <li className="flex items-start gap-3 text-gray-300">
                ...
                <div>
                  ...
                  <a href="mailto:info@cooperativapantarei.it" className="hover:text-[#248acc] transition-colors block text-sm">
